...
export const GET_LEFT_NAV_ITEMS = () => {
  const LEFT_NAV_ITEMS = [
    ...
    new NavigationItem(
      ...
      'movies',
      ['/', 'movies'],
      <MovieIconOutlined color="primary" />
    ),
    new NavigationItem(
      'Characters',
      'characters',
      ['/', 'characters'],
      <Person4IconOutlined color="primary" />
    ),
    new NavigationItem(
      'Planets',
      'planets',
      ['/', 'planets'],
      <PublicIconOutlined color="primary" />
    ),
    new NavigationItem(
      'Vehicles',
      'vehicles',
      ['/', 'vehicles'],
      <TwoWheelerIconOutlined color="primary" />
    ),
    new NavigationItem(
      'Starships',
      'starships',
      ['/', 'starships'],
      <RocketIconOutlined color="primary" />
    ),
    new NavigationItem(
      'Species',
      'species',
      ['/', 'species'],
      <GroupsIconOutlined color="primary" />
    ),
    new NavigationItem(
      'Mine',
      'personal-films',
      ['/', 'personal-films'],
      <CameraRollOutlined color="primary" />
    ),
    new NavigationItem(
      'Add',
      'create-new',
